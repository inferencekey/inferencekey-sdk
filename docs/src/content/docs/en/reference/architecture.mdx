...
Ready to provision your first workload? [Open the Manager dashboard](https://manager.inferencekey.com) to create an account and mint your tokens. Learn more at [inferencekey.com](https://inferencekey.com).