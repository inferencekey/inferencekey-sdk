...
<Aside type="note">
The config schema may gain fields over time, but these keys are what the current Manager validates. The [workloads guide](/guides/workloads-by-policy-worker-modality/) shows them in context per modality.
</Aside>
