...
[Tokens](/reference/tokens/) for the full model.
...
(driven by [`OnDrift`](/reference/ondrift/), default `RECONCILE`).
...
send only what changes. This is what [`OnDrift.RECONCILE`](/reference/ondrift/)
...
`PermissionDenied`. See [Common errors](/reference/common-errors/).
...
<CardGrid>
  <LinkCard title="Tokens" href="/reference/tokens/" description="ik_sdk_ vs ik_live_, scopes, and precedence." />
  <LinkCard title="OnDrift" href="/reference/ondrift/" description="How ensure() decides between POST, PATCH, and failing." />
  <LinkCard title="Backends & policies" href="/reference/backends-and-policies/" description="Backend wire strings and execution policies." />
  <LinkCard title="Common errors" href="/reference/common-errors/" description="Typed error codes and how the SDK maps them." />
</CardGrid>

<p>
  New here? <a href="https://manager.inferencekey.com">Create an account or open the dashboard</a> to mint your first tokens.
</p>
