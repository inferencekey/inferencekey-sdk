...
TypeScript SDKs through the stable [C ABI](/en/reference/architecture/) (cgo), so
behaviour — `ensure()` idempotency, [`OnDrift`](/en/reference/ondrift/), the
...
[wire format](/en/reference/wire-format/) for the exact contract.
