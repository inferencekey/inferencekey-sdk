...
(default [`OnDrift.Reconcile`](/reference/ondrift/)). Idempotency is keyed by
...
<Aside type="note">
  ...
  [Backends &amp; policies](/reference/backends-and-policies/).
</Aside>
...
[OnDrift](/reference/ondrift/) for what each mode does.
