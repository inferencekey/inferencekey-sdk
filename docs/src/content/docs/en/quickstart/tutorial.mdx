...
- An InferenceKey account and a project. <LinkCard title="Create an account / open the dashboard" href="https://manager.inferencekey.com" description="Sign up or open the Manager dashboard to create your project and tokens." />
...
2. ### Get your tokens
   ...
   Open the [Manager dashboard](https://manager.inferencekey.com) and create two tokens **for the same project**:
...
3. ### Set your environment
   ...
   The SDK reads configuration from environment variables. Precedence is **explicit argument > environment variable > config file**, so anything you pass in code wins.
...
Built something with this? [Open the Manager dashboard](https://manager.inferencekey.com) to watch your workload, or head back to [inferencekey.com](https://inferencekey.com).
