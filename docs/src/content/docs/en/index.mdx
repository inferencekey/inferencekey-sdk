...
1. **Get two tokens.** A control token (`ik_sdk_`) to provision and a data token (`ik_live_`) to call inference. Create both in the [dashboard](https://cloud.inferencekey.com) — see [Tokens](/en/quickstart/tokens/).
